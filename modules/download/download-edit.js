...
$(document).ready(function () {
  ...
  elem = $(
    '<img src="' +
    $.glue.base_url +
    'img/download.png" alt="btn" title="download file" width="32" height="32">',
  );
  ...
  $(elem).bind("glue-menu-activate", function (e) {
    ...
    $.glue.backend(
      { method: "glue.load_object", name: $(obj).attr("id") },
      function (data) {
  ...
  $(elem).bind("click", function (e) {
    ...
    if ($(this).hasClass("glue-menu-enabled")) {
      ...
      $.glue.backend({
        method: "glue.object_remove_attr",
        name: $(obj).attr("id"),
        attr: "download-public",
      });
